def read_unit_data(unit):
    ...
    for line in reader.readlines():
        ...
        online_assets.append(data_array[0])
        maintenance_assets.append(data_array[1])
        eol_assets.append(data_array[2])
        assets_required.append(data_array[3])
        transfers.append(data_array[4])
        time_steps.append(data_array[5])
...
def read_global_data():
    ...
    for line in reader.readlines():
        ...
        eol_assets.append(data_array[2])
        assets_required.append(data_array[3])
        time_steps.append(data_array[4])
